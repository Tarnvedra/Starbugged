                    ...
                    <div class="sbp-preview-content">
                        <form action="/admin/user/store" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="jobtitle" type="text" class="form-control @error('jobtitle') is-invalid @enderror" name="jobtitle" value="{{ $user->job_title}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="profileimage" type="text" class="form-control @error('profileimage') is-invalid @enderror" name="profileimage" value="{{ $user->profile_image}}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="aboutme" type="text" class="form-control @error('aboutme') is-invalid @enderror" name="aboutme" value="{{ $user->about_me}}" autofocus>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-4 offset-md-4">
                                    ...
                                    <a href="/admin/user/profile" class="btn btn-danger">  {{ __('Cancel') }}</a>
                                </div>
