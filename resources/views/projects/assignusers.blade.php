            ...
            <div class="card-body">
                <div class="sbp-preview">
                    <div class="sbp-preview-content">
                        <form action="/projects/assignment/{{ $project->id }}/update" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PATCH')

                            <div class="form-group row">

                                <label for="project" class="col-md-4 col-form-label text-md-right">{{ __(' Project: ') }} <i><b>{{ $project->project }}</b></i></label>
                            ...
                            <div class="form-group row d-flex">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->username }}</td>
                                        <td><input type="checkbox" id="assignment" name="assignment[]" class="form-control @error('assignment') is-invalid @enderror" value="{{ $user->username }}" autocomplete="" autofocus></td>
