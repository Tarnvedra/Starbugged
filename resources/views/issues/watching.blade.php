        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Issues watched by <i><b>{{ $user->name }}</b></i></h1>
                    <p class="mb-4">View all tickets watched by <i>{{ $user->name }}</i></p>
                                ...
                                <div class="sbp-preview-content">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        @foreach($issues as $issue)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('issue.show', $issue->id) }}">{{  $issue->id  }}</a>
                                                </td>
                                                <td>
